...
<main class="@container flex-1 *:p-4 bg-secondary-container text-secondary-container-fg">
	<div class="bg-secondary-container flex justify-between gap-8 items-center">
		...
		<div class="hidden gap-4 @md:flex">
			<BgUpload class="c-button--secondary" />
			<ThemeSwitch buttonClass="c-button--secondary" />
			<a
				href="https://github.com/duydang2311/later-app"
				aria-label="Github"
				target="_blank"
				title="Open Github"
				class="[view-transition-name:github-link] c-button c-button--secondary"
			>
				<Github />
			</a>
		</div>
